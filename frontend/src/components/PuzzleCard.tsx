...
export default function PuzzleCard({ puzzle }: { puzzle: PuzzleCardType }) {
  return (
    <div className={`bg-white/30 backdrop-blur-sm border-slate-200 hover:border-slate-300 hover:bg-slate-200/20 transition-all duration-200 md:w-4/5 w-full flex px-2 py-4 border rounded-md flex-col`}>
